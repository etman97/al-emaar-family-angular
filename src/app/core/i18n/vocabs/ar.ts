export const locale = {
  ...
  data: {
    ...
    OUR_COMPANIES: {
      TITLE: 'شركاتنا',
      DESCRIPTION: 'نـص افتتاحـي عشوائي للتصميم نـص افتتاحـي عشوائي للتصميم نـص افتتاحـي عشوائي للتصميم',
      COMPANY_1: {
        TITLE: 'الشركة 1',
        INTRO_TEXT_1: 'نـص افتتاحـي عشوائي للتصميم نـص افتتاحـي عشوائي للتصميم نـص افتتاحـي عشوائي للتصميم',
